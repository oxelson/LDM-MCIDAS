 ...
 */
/* $Id: mkdirs_open.h,v 1.1 1997/12/22 21:29:02 yoksas Exp $ */
#ifndef _MKDIRS_H_
#define _MKDIRS_H_
 ...
 */
#ifdef __cplusplus
extern "C" int mkdirs(char *path, mode_t mode);
#elif defined(__STDC__)
extern int mkdirs(char *path, mode_t mode);
#else /* Old Style C */
extern int mkdirs();
#endif
 ...
 */
#ifdef __cplusplus
extern "C" int mkdirs_open(char *path, int flags, mode_t mode);
#elif defined(__STDC__)
extern int mkdirs_open(char *path, int flags, mode_t mode);
#else /* Old Style C */
